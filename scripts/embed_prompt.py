#!/usr/bin/env python3
"""
Converts pdbsql_agent.md to a C++ header with embedded raw string literal.
Only regenerates if the hpp is older than the md or doesn't exist.

Run: python scripts/embed_prompt.py prompts/pdbsql_agent.md src/common/pdbsql_agent_prompt.hpp
"""
